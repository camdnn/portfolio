...
const socials = [
  {
    name: "GitHub",
    href: "https://github.com/camdnn",
    icon: <AiOutlineGithub className="size-[18px]" />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/camden-mann-461249328/",
    icon: <FaLinkedin className="size-[18px]" />,
  },
  {
    name: "Resume",
    href: "/images/Resume - Camden Mann.pdf",
    icon: <GrDocumentText className="size-[18px]" />,
  },
]
